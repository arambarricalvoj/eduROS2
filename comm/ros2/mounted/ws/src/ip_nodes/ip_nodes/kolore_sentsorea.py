...
El cilindro se dibuja centrado en su origen. Es decir, si scale.z = 0.2, el cilindro mide 20 cm de alto y se extiende 0.1 m hacia arriba y 0.1 m hacia abajo desde pose.position."""
