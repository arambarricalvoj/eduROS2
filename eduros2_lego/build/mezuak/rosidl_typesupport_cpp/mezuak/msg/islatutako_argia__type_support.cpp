...
static const _IslatutakoArgia_type_support_symbol_names_t _IslatutakoArgia_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mezuak, msg, IslatutakoArgia)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mezuak, msg, IslatutakoArgia)),
  }
};
...
{
  return &::mezuak::msg::rosidl_typesupport_cpp::IslatutakoArgia_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mezuak, msg, IslatutakoArgia)() {
  return get_message_type_support_handle<mezuak::msg::IslatutakoArgia>();
}
