...
static const _MugimenduKodetzaileak_type_support_symbol_names_t _MugimenduKodetzaileak_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mezuak, msg, MugimenduKodetzaileak)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mezuak, msg, MugimenduKodetzaileak)),
  }
};
...
{
  return &::mezuak::msg::rosidl_typesupport_cpp::MugimenduKodetzaileak_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mezuak, msg, MugimenduKodetzaileak)() {
  return get_message_type_support_handle<mezuak::msg::MugimenduKodetzaileak>();
}
