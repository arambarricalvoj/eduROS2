...
size_t mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__size_function__MugimenduKodetzaileak__abiadurak(
  const void * untyped_member)
{
  (void)untyped_member;
  return 2;
...
const void * mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__get_const_function__MugimenduKodetzaileak__abiadurak(
  const void * untyped_member, size_t index)
{
...
void * mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__get_function__MugimenduKodetzaileak__abiadurak(
  void * untyped_member, size_t index)
{
  int16_t * member =
...
void mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__fetch_function__MugimenduKodetzaileak__abiadurak(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const int16_t * item =
    ((const int16_t *)
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__get_const_function__MugimenduKodetzaileak__abiadurak(untyped_member, index));
  int16_t * value =
    (int16_t *)(untyped_value);
  *value = *item;
}

void mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__assign_function__MugimenduKodetzaileak__abiadurak(
  void * untyped_member, size_t index, const void * untyped_value)
{
  int16_t * item =
    ((int16_t *)
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__get_function__MugimenduKodetzaileak__abiadurak(untyped_member, index));
  const int16_t * value =
    (const int16_t *)(untyped_value);
  *item = *value;
}

static rosidl_typesupport_introspection_c__MessageMember mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__MugimenduKodetzaileak_message_member_array[2] = {
  {
    "graduak",  // name
  ...
  },
  {
    ...
    2,  // array size
    false,  // is upper bound
    offsetof(mezuak__msg__MugimenduKodetzaileak, abiadurak),  // bytes offset in struct
    NULL,  // default value
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__size_function__MugimenduKodetzaileak__abiadurak,  // size() function pointer
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__get_const_function__MugimenduKodetzaileak__abiadurak,  // get_const(index) function pointer
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__get_function__MugimenduKodetzaileak__abiadurak,  // get(index) function pointer
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__fetch_function__MugimenduKodetzaileak__abiadurak,  // fetch(index, &value) function pointer
    mezuak__msg__MugimenduKodetzaileak__rosidl_typesupport_introspection_c__assign_function__MugimenduKodetzaileak__abiadurak,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  }
};
