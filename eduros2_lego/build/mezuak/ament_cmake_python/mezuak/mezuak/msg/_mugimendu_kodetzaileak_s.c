...
bool mezuak__msg__mugimendu_kodetzaileak__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mezuak.msg._mugimendu_kodetzaileak.MugimenduKodetzaileak", full_classname_dest, 56) == 0);
  }
  mezuak__msg__MugimenduKodetzaileak * ros_message = _ros_message;
  {  // graduak
    PyObject * field = PyObject_GetAttrString(_pymsg, "graduak");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 2;
      int8_t * dest = ros_message->graduak;
  ...
  {  // abiadurak
    PyObject * field = PyObject_GetAttrString(_pymsg, "abiadurak");
    if (!field) {
      return false;
    }
    {
      ...
      Py_ssize_t size = 2;
      int16_t * dest = ros_message->abiadurak;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
{
  /* NOTE(esteve): Call constructor of MugimenduKodetzaileak */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mezuak.msg._mugimendu_kodetzaileak");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MugimenduKodetzaileak");
  ...
  {  // graduak
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "graduak");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int8_t * src = &(ros_message->graduak[0]);
    memcpy(dst, src, 2 * sizeof(int8_t));
    Py_DECREF(field);
  }
  {  // abiadurak
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "abiadurak");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    int16_t * src = &(ros_message->abiadurak[0]);
